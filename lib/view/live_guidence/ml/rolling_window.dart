...
class RollingWindow {
  ...
  static const int windowSize = DetectionConstants.windowSize;

  /// Minimum positive frames needed to trigger [DetectionState.confirmed].
  static const int requiredPositives = DetectionConstants.requiredPositives;
  ...
  static const int resetAfterConsecutiveFalse = 6;
