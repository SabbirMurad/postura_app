...
class SignatureSectionCPE extends StatelessWidget {
  ...
  const SignatureSectionCPE({super.key, required this.state, required this.notifier});

  @override
  Widget build(BuildContext context) {
    final localPath = state.signaturePath;
    final remoteUrl = state.signatureRemoteUrl;
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: const Color(0xFFBDD0FF), width: 1.5),
            ),
            child: hasAny
                ? Stack(
                    children: [
                      ...
                      if (hasLocal)
                        Positioned(
                          ...
                          child: GestureDetector(
                            onTap: notifier.removeSignature,
                            child: Container(
        ...
        Align(
          ...
          child: Text(
            '${(state.signaturePath.isNotEmpty || state.signatureRemoteUrl.isNotEmpty) ? 1 : 0}/500',
